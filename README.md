...
**Calculator** is a web application where users can perform simple calculations. 
...
```sh
  git clone https://github.com/MAleemH/Calculator.git
```

### Install

You need to copy cloned repository into htdocs folder which is located inside xampp folder in windows partition.

### Usage

To run the project, you need to run XAMPP server first. Then you need to open your preferred browser and then type 'localhost/Calculator' in URL and press enter.
...
Thanks to everyone whoever helped me in this project.
